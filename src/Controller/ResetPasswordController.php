...
class ResetPasswordController extends AbstractController
{
    ...
    public function __construct(ResetPasswordHelperInterface $resetPasswordHelper, TranslatorInterface $translator, array $resetPasswordControllerOptions)
    {
        ...
        $this->options = $resolver->resolve($resetPasswordControllerOptions);
    }
    ...
    public function request(Request $request, MailerInterface $mailer): Response
    {
        ...
        return $this->render('@ItkDevUser/EasyAdmin-2.x/reset_password/request.html.twig', [
            ...
            'username_label' => $this->translator->trans('E-mail'),
    ...
    public function reset(
        ...
        return $this->render('@ItkDevUser/EasyAdmin-2.x/reset_password/reset.html.twig', [
            'form' => $form->createView(),
            'password_label' => $this->translator->trans('Password'),
            'password_repeat_label' => $this->translator->trans('Repeat password'),
        ]);
    }
