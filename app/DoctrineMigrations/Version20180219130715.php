...
class Version20180219130715 extends AbstractMigration
{
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE answer DROP company, DROP address, DROP documentation_id, CHANGE title title VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, CHANGE name author VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci');
    }
}
